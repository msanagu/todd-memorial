...
import { MapPin, Clock, Info, Car, ChevronDown, ChevronUp, Navigation } from 'lucide-react';
      ...
      >
        <div className="flex justify-between items-start">
          <div className="flex-1">
            <h3 className="font-serif text-2xl text-navy-900 font-semibold mb-1">{event.title}</h3>
        ...
        <div className="p-6 pt-2">
          ...
          <div className="mb-6">
            <div className="flex items-start mb-2">
              ...
              <div>
                <p className="font-semibold text-stone-900">{event.location.name}</p>
          ...
          <div className="bg-stone-50 rounded-lg p-4 border border-stone-100">
            <div className="flex items-start mb-3">
              ...
              <div>
                <h4 className="font-bold text-stone-800 text-sm uppercase tracking-wide mb-1">Parking & Arrival</h4>
                <p className="text-stone-600 text-sm leading-relaxed">{event.parkingInfo}</p>
              </div>
            </div>
            ...
            {event.notes && event.notes.length > 0 && (
              <div className="flex items-start mt-4 pt-4 border-t border-stone-200">
                ...
                <div>
                  <h4 className="font-bold text-stone-800 text-sm uppercase tracking-wide mb-1">Important Notes</h4>
